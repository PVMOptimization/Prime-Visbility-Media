...
const tiers = [
  {
    ...
    features: [
      "Complete Google Business Profile rebuild & optimization",
      "Top 5 Map Pack positioning structure",
      "Automated 5-Star Review Generation System",
      "High-converting mobile-first landing page",
      "Call tracking & missed opportunity capture setup"
    ],
    purpose: "Fix low visibility, weak trust, and missed local leads",
  ...
  },
  {
    ...
    price: "$2,500",
    sub: "Build + $599/month optimization",
    color: "#2ea8c9",
    bg: "linear-gradient(145deg, #0d1f2e, #091828)",
    features: [
      "Everything in Visibility Foundation",
      "Top 3 Map Pack Authority Strategy",
      "3–5 Page Conversion-Focused Website",
      "Full Local SEO Structure & Content Framework",
      "Automated Review + Reputation Flywheel",
      "24/7 AI Appointment Capture",
      "Monthly growth reporting & ranking expansion"
    ],
    purpose: "Consistent inbound leads without chasing referrals",
